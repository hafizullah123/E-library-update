...
$texts = [
  'en' => [
    ...
    'footer' => '&copy; 2025 kabul educatuion  University E-Library. All rights reserved.',
    'lang_ps' => 'پښتو',
    'lang_fa' => 'دری',
    'lang_en' => 'English',
  ],
  'ps' => [
    'title' => 'د کابل  ښوونې او روزنې پوهنتون برېښنايي کتابتون',
    'site_title' => 'د کابل  ښوونې او روزنې پوهنتون برېښنايي کتابتون',
    'home' => 'کور',
    'services' => 'خدمات',
    'books' => 'کتابونه',
    'contact' => 'اړیکه',
    ...
    'footer' => '&copy; ۲۰۲۵ د کابلښونې اوروزنې پوهنتون برېښنايي کتابتون. ټول حقوق خوندي دي.',
    'lang_ps' => 'پښتو',
    'lang_fa' => 'دری',
    'lang_en' => 'English',
  ],
  'fa' => [
    'title' => 'کتابخانه الکترونیکی پوهنتون تعلیم و تربیه کابل',
    ...
    'footer' => '&copy; ۲۰۲۵ کتابخانه الکترونیکی پوهنتون تعلیم وتربیه کابل \. همه حقوق محفوظ است.',
    'lang_ps' => 'پښتو',
    'lang_fa' => 'دری',
    'lang_en' => 'English',
  ],
